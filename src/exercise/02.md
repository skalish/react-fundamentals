...
`React.createElement` produces a react object that can then be rendered with `ReactDOM.render`.  It takes 2+ arguments: the type, a map of properties, any number of "children" elements (which can also be specified in the property "children").
...
Fill out
[the feedback form](https://ws.kcd.im/?ws=React%20Fundamentals%20%E2%9A%9B&e=02%3A%20Intro%20to%20raw%20React%20APIs&em=samuel.kalish%40tamr.com).
